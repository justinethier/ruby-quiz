    ...
    while list != nil
      ...
      for result in results
        for item in list
          ...
          new_result << item
          new_results << new_result # TODO: Check if item already in result list
        end
      end
...
#results = find_list_combinations([[1, 2], [4, 5], [6]])
results = /(lovely|delicious|splendid)(food|snacks|munchies)/.generate
results = /Hello, my name is (Linus|Yukihiro|Dennis) (Torvalds|Matsumoto|Ritchie)/.generate
